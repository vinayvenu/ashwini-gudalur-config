Select (select count(*) from patient p
  ...
  join concept_class cc on cc.concept_class_id = c.class_id and cc.concept_class_id=26 where o.date_created between between '#startDate#' and '#endDate#') as TribalIPD,
