{
    ...
    'data':['module_misc.xml','attribute_in_sale_order.xml','price_in_stock_product_lot.xml','claim_type.xml','sale_order_type_shop_form.xml','sale_care_setting_form.xml','product_category_department.xml','chargetype_category_mapping.xml'],
    'demo':[],
    'auto_install':False,
    'application':True,
    'installable':True,
